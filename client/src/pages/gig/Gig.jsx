...
//CETTE PAGE EST AFFICHEE POUR PAR EX: http://localhost:5173/gig/651db85b4dd274db51554fbd
...
function Gig() {
  ...
  const { isLoading, error, data, refetch } = useQuery({ //useQuery: effectuer des requêtes à un serveur
    queryKey: ['gig'], //'gig': clé de la requête pour identifier la requête & la mémoriser dans le cache de React Query. 
    queryFn: () => 
  ...
  //On réutilise useQuery pour recup les users, mais on doit renommer les objets isLoading, etc...
  const { 
